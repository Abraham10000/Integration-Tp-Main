...
import AddButon from "./components/Bouton";
import axios from "axios";
import Module from "./components/Module";
import "./components/List/module.css"
function App() {
  const [stile,setStile] = useState('module');
          ...
          <main>
            <div className="container-fluid px-4">
              ...
              <Card>
                ...
                . <br/>
                <br/>
                <AddButon className="ajouter" setStyle = {setStile} label = "Ajouter"/>
              <br/>
              </Card>
              <Module style={stile} setStyle={setStile} />
